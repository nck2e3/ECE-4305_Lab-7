...
design_libs=(microblaze_v11_0_13 xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_24 blk_mem_gen_v8_4_8 axi_lite_ipif_v3_0_4 mdm_v3_2_26 xlconcat_v2_1_6 iomodule_v3_1_10)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k \
  ...
  vlogan -work xlconcat_v2_1_6 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.microblaze_mcs_0 xil_defaultlib.glbl -o microblaze_mcs_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./microblaze_mcs_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key microblaze_mcs_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc microblaze_mcs_0_simv.daidir vcs_lib c.obj)
