...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L microblaze_v11_0_13 -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_24 -L blk_mem_gen_v8_4_8 -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_26 -L xlconcat_v2_1_6 -L iomodule_v3_1_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot microblaze_mcs_0 xil_defaultlib.microblaze_mcs_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim microblaze_mcs_0 -key {Behavioral:sim_1:Functional:microblaze_mcs_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fc5c_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb microblaze_mcs_0.wdb xsim.dir libdpi.so)
