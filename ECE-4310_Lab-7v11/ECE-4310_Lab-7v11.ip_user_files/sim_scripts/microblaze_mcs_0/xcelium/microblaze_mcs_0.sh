...
#
# Script generated by Vivado on Wed Oct 30 22:55:31 PDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : microblaze_mcs_0.sh
...
#
# Usage        : microblaze_mcs_0.sh
#                microblaze_mcs_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                microblaze_mcs_0.sh [-reset_run]
#                microblaze_mcs_0.sh [-reset_log]
#                microblaze_mcs_0.sh [-help]
#
...
#                script (type 'microblaze_mcs_0.sh -help' for more information).
#
...
design_libs_elab="-libname microblaze_v11_0_13 -libname xil_defaultlib -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname lmb_v10_v3_0_14 -libname lmb_bram_if_cntlr_v4_0_24 -libname blk_mem_gen_v8_4_8 -libname axi_lite_ipif_v3_0_4 -libname mdm_v3_2_26 -libname xlconcat_v2_1_6 -libname iomodule_v3_1_10 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver microblaze_v11_0_13 xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_24 blk_mem_gen_v8_4_8 axi_lite_ipif_v3_0_4 mdm_v3_2_26 xlconcat_v2_1_6 iomodule_v3_1_10)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "microblaze_mcs_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./microblaze_mcs_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts \
  ...
  xmvhdl -work mdm_v3_2_26 -V93 $xmvhdl_opts \
  ...
  xmvlog -work xlconcat_v2_1_6 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.microblaze_mcs_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.microblaze_mcs_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log microblaze_mcs_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./microblaze_mcs_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: microblaze_mcs_0.sh [-help]\n\
Usage: microblaze_mcs_0.sh [-step]\n\
Usage: microblaze_mcs_0.sh [-lib_map_path]\n\
Usage: microblaze_mcs_0.sh [-reset_run]\n\
Usage: microblaze_mcs_0.sh [-reset_log]\n\
Usage: microblaze_mcs_0.sh [-keep_index]\n\
Usage: microblaze_mcs_0.sh [-noclean_files]\n\n\
